...
var map = new AMap.Map('container', {
	...
	// features: ['bg','road'],
	center: [107.03616000000001, 10.280660000000001],
	zoom: 6,
	pitch: 46,
	viewMode: '3D',
});
...
function getData(){
	//加载数据
	$.get("http://127.0.0.1/periodData/period.json", function (data) {
		
		var colors = ['#07E8E4','#1f78b4','#b2df8a','#33a02c','#fb9a99','#e31a1c','#fdbf6f','#ff7f00','#cc99ff','#00ff00','#eee5ff',
		'#ffff99','#ff9f80','#00b33c','#99e6ff','#4dffd2','#b3e6ff','#ff80ff'];
